...
import 'package:flappy_bat/game/collision/collision_box.dart';
...
import 'package:flappy_bat/game/obstacle/config.dart';
import 'package:flappy_bat/game/obstacle/obstacle_type.dart';
...
class Obstacle extends SpriteComponent with Resizable {
  Obstacle(
    ...
    internalSize =
        getRandomNum(1.0, ObstacleConfig.maxGapCoefficient / 1).floor();
